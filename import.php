...
if($action == "xml") {
	...
	if (block_desp_check_table("block_desp_cultures_items")==false){
		block_desp_importtable("xml/desp_lernculture_items.xml","block_desp_cultures_items");
	}

	if (block_desp_check_table("block_desp_cultures_item_cat")==false){
		block_desp_importtable("xml/desp_lernculture_items_cats.xml","block_desp_cultures_item_cat");
	}


	if (block_desp_check_table("block_desp_learnplan_items")==false){
