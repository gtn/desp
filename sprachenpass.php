...
if ($showgers==true){
	if ($printversion==false){
		...
		<tr>
		<td class="spgers_s1" rowspan="2"><img src="images/gersverstehen.jpg" alt="Gers verstehen" /></td>
		<td class="spgers_s2"><img src="images/gershoeren.jpg" alt="'.get_string("hoehren","block_desp").'" /></td>
		...
		<tr>
		<td class="spgers_s2"><img src="images/gerslesen.jpg" alt="'.get_string("lesen","block_desp").'" /></td>
		...
		<tr>
		<td class="spgers_s1" rowspan="2"><img src="images/gerssprechen.jpg" alt="'.get_string("sprechen","block_desp").'" /></td>
		<td class="spgers_s2"><img src="images/gersgespr.jpg" alt="Gers sprechen" /></td>
		...
		<tr>
		<td class="spgers_s2"><img src="images/zusammenhspr.jpg" alt="'.get_string("zusammenhaengendsprechen","block_desp").'" /></td>
		...
		<tr>
		<td class="spgers_s1"><img src="images/gersschreiben1.jpg" alt="'.get_string("schreiben","block_desp").'" /></td>
		<td class="spgers_s2"><img src="images/gersschreiben2.jpg" alt="'.get_string("schreiben","block_desp").'" /></td>
		...
		<tr>
		<td class="spgers_s1" rowspan="2"><img src="images/gersverstehen.jpg" alt="'.get_string("verstehen","block_desp").'" /></td>
		<td class="spgers_s2"><img src="images/gershoeren.jpg" alt="'.get_string("hoehren","block_desp").'" /></td>
		...
		<tr>
		<td class="spgers_s1" rowspan="2"><img src="images/gerssprechen.jpg" alt="'.get_string("sprechen","block_desp").'" /></td>
		<td class="spgers_s2"><img src="images/gersgespr.jpg" alt="'.get_string("angespraechenteilnehmen","block_desp").'" /></td>
...
function get_score($skillid,$niveauid,$langid,$userid){
	...
	if (!empty($USER->desp[$langid]["showmode"]) && ($USER->desp[$langid]["showmode"]==2 || $USER->desp[$langid]["showmode"]==1)) {$inhalt.= '<b>'.trim($item->name).'</b>';
